-- Customer admin pagination: aggregate verified phones, buyers and offline registrations
-- server-side so the browser never downloads thousands of source rows.
