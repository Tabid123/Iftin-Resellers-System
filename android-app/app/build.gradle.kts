// Iftin Resellers delivery agent
plugins {
...
android {
    ...
    defaultConfig {
        ...
        // Supabase backend — overridable from CI (SUPABASE_URL / SUPABASE_ANON_KEY)
        val supabaseUrl = System.getenv("SUPABASE_URL")?.takeIf { it.isNotBlank() }
            ?: "https://bpkddmxpyeyxvjyebull.supabase.co"
        ...
        // No SIM PIN is compiled in; it always comes from the server (device-config / order).
        buildConfigField("String", "DEFAULT_SIM_PIN", "\"\"")
    }
